...
class SecurityController extends AbstractController
{
    ...
    public function login(AuthenticationUtils $authenticationUtils): Response
    {
        ...
        return $this->render('ChadprodTemplates/Chadprod/security/login.html.twig', ['last_username' => $lastUsername, 'error' => $error]);
    }
    ...
    public function registerEdit(Request $request, EntityManagerInterface $manager) {
        ...
        return $this->render('ChadprodTemplates/Chadprod/registration/registerEdit.html.twig', [
    ...
    public function passwordEdit(Request $request, EntityManagerInterface $manager) {
        ...
        return $this->render('ChadprodTemplates/Chadprod/registration/passwordEdit.html.twig', [
            'form' => $form->createView()
        ]);
    }
}
